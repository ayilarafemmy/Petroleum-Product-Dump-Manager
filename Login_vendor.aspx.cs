...
public partial class Login : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "select * from Staff where Phone='" + TextBox1.Text + "' and Password='" + TextBox2.Text + "' and Position = 'Level3'";
        cmd.Connection = con;
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            Response.Redirect("Defaultc.aspx");
        }
        else
        {
            MessageBox("Username or Password is incorrect, Please check and try again. Kindly Note that this access right is for Vendorshmn Only,Kindly choose the right Profile");
