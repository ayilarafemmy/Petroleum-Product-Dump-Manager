<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login_control.aspx.cs" Inherits="Login" %>
    ...
    <form id="form1" runat="server">
        <div style="background-image: url('login_BG.jpg')">
            ...
            <table class="auto-style1">
                <tr>
                    <td class="auto-style4" colspan="2"><strong>iManager&nbsp; </strong><span class="auto-style12"><em>- Staff login </em></span><strong>&nbsp;&nbsp;(Control Staff)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></td>
