...
public partial class Login : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "select * from Staff where Phone='" + TextBox1.Text + "' and Password='" + TextBox2.Text + "' and Position = 'MD'";
        cmd.Connection = con;
        ...
        {
            MessageBox("Username or Password is incorrect, Please check and try again. Kindly Note that this access right is for MD Only,Kindly choose the right Profile");
